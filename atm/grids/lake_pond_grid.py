...
class LakePondGrid (TemporalMultiGrid):
    ...
    def __init__ (self, *args, **kwargs):
        ...
        ## These get initialized to zero given the current setup
        #############
        ...
        ### this is not needed as data is initilzed to 0, but I'm
        ### leaving it in incase this ever needs to be randomly initialized 
        ### can cheat and use setup depths
        # self.time_since_growth = self.setup_random_range(
        #     [t + '_time_since_growth' for t in config['pond types']],
        #     self.shape, 
        #     (0,0)
        # )
    ...
    ## all of the get functions can be done with Temporal_MG
