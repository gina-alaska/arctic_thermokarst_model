...
def transition (name, year, grids, control):
    ...
    from_cohort, from_cohort_a0, to_cohort, to_cohort_a0, ice_slope,
    ...
    # print (params.dtype, x.dtype, above_idx.dtype)
    ...
    # print(rate_of_transition.dtype, from_cohort.dtype, present.dtype)
